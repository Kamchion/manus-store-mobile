...
importers:
  ...
  .:
    dependencies:
      ...
      drizzle-orm:
        specifier: ^0.44.5
        version: 0.44.6(mysql2@3.15.1)(sql.js@1.13.0)
...
packages:
  ...
  '@aws-sdk/client-sesv2@3.914.0':
    resolution: {integrity: sha512-dg36AsIyBJ6BKL0bFTIAnIk7nBsgaYGUJxdTfT/jNpYv+F239Ih7tvZfJSfjd1jvBw4byzlqjdPuKnl9l5ovDg==}
    engines: {node: '>=18.0.0'}
  ...
  '@capacitor/network@7.0.2':
    resolution: {integrity: sha512-KKkiUvGfMVKIcYaG+KlGAxrQtoRnwJtT+9yhTkCFzZWeYrY91sBZKOVOfnNHO8RiOxqbKn5VSUlyFLQQiyyfyg==}
    peerDependencies:
      '@capacitor/core': '>=7.0.0'
...
snapshots:
  ...
  '@capacitor/network@7.0.2(@capacitor/core@7.4.4)':
    dependencies:
      '@capacitor/core': 7.4.4
  ...
  drizzle-orm@0.44.6(mysql2@3.15.1)(sql.js@1.13.0):
    optionalDependencies:
      mysql2: 3.15.1
      sql.js: 1.13.0
